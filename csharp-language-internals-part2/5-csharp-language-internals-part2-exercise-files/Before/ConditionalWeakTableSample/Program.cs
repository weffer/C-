...
{
    private static ConcurrentDictionary<object, ConcurrentDictionary<string, object>> _properties = new ConcurrentDictionary<object, ConcurrentDictionary<string, object>>();
    ...
    {
        return _properties.GetOrAdd(key, _ => new ConcurrentDictionary<string, object>());
    }
}
